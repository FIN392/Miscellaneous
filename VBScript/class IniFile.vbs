...
WScript.Echo "*** Create INIFile with a section, a key and give it value"
objInifile.FileName = ".\TEST.ini"
objInifile.Section  = "Section"
objInifile.Key      = "Key"
objInifile.Value    = "Value"
WScript.Echo objInifile.Content
WScript.Echo ""

WScript.Echo "***  Add a section, a key and give it value"
objInifile.Section  = "Section-2"
objInifile.Key      = "Key-2"
objInifile.Value    = "Value-2"
WScript.Echo objInifile.Content
WScript.Echo ""

WScript.Echo "***  Delete a key"
objInifile.Key      = "Key-2"
objInifile.Value    = ""
WScript.Echo objInifile.Content
WScript.Echo ""

WScript.Echo "***  Delete INIFile"
objInifile.Content = " "
WScript.Echo objInifile.Content
WScript.Echo ""
